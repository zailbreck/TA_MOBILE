...
import com.kaori.ssa.config.*
import com.kaori.ssa.config.cDrawer.ClickListener
import com.kaori.ssa.config.cDrawer.NavigationItemModel
import com.kaori.ssa.config.cDrawer.NavigationRVAdapter
import com.kaori.ssa.config.cDrawer.RecyclerTouchListener
import com.kaori.ssa.menu.*
import khttp.post
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun getData(){
        ...
        try{
            val str = URL("https://smart-students-assistant-default-rtdb.firebaseio.com/building/MapLoc.json").readText(
                Charset.forName(
                    "UTF-8"
                )
            )
